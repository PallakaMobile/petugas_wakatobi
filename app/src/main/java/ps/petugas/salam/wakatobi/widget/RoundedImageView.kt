package ps.petugas.salam.wakatobi.widget
...
class RoundedImageView : AppCompatImageView {
    ...
    @JvmOverloads constructor(context: Context, attrs: AttributeSet, defStyle: Int = 0) : super(context, attrs, defStyle) {
        ...
        mFillColor = a.getColor(R.styleable.RoundedImageView_riv_fill_color, DEFAULT_FILL_COLOR)
    ...
    override fun setScaleType(scaleType: ScaleType) {
        if (scaleType != SCALE_TYPE) {
            throw IllegalArgumentException(String.format("ScaleType %Response not supported.", scaleType))
        }
    }
    ...
    companion object {
        ...
        private val SCALE_TYPE = ScaleType.CENTER_INSIDE
